  ...
  public static void main(String[] args) {
    ...
    do {
        ...
        do {
          ...
          switch (opcionListado) {
            ...
            case 2: // Listado por autor ////////////////
              ...
              final String autor = autorIntroducido;
              ArrayList<Disco> aux = album.stream().filter(d->d.getAutor().equals(autor)).collect(Collectors.toCollection(ArrayList<Disco>::new));
      ...
      case 3:
        ...
        codigoIntroducido = s.nextLine();
        Disco d = new Disco(codigoIntroducido,"", "", "", 0);
        while (!album.contains(d)) {
